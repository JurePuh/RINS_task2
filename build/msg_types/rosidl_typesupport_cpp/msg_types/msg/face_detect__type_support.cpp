...
static const _FaceDetect_type_support_symbol_names_t _FaceDetect_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_types, msg, FaceDetect)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_types, msg, FaceDetect)),
  }
};
...
{
  return &::msg_types::msg::rosidl_typesupport_cpp::FaceDetect_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_types, msg, FaceDetect)() {
  return get_message_type_support_handle<msg_types::msg::FaceDetect>();
}
