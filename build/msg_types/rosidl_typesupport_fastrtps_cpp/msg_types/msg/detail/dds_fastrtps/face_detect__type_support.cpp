...
#include "msg_types/msg/detail/face_detect__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_types::msg::FaceDetect;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_types::msg::FaceDetect *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_types::msg::FaceDetect *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FaceDetect__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const msg_types::msg::FaceDetect *>(
...
static size_t _FaceDetect__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FaceDetect(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FaceDetect__callbacks = {
  "msg_types::msg",
  "FaceDetect",
...
static rosidl_message_type_support_t _FaceDetect__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FaceDetect__callbacks,
...
{
  return &msg_types::msg::typesupport_fastrtps_cpp::_FaceDetect__handle;
}
